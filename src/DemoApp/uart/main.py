...
# test = "nsh>" # "NuttShell (NSH)" # "nsh>"

# ser = serial.Serial(COM, bitRate, timeout=0.1) # 3)
# while True:
#     # result = ser.read_all()
...
#     print(RecieveData)
#     if test in RecieveData: # result: # l_in:
#         serial_write()
#     if RecieveData == b'\r': # <Enter>で終了
#         break
