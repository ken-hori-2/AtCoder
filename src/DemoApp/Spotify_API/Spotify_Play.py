...
# プレイリスト生成(キーワードから関連のアーティストでプレイリスト生成)
...
# import win32api
# # デバイス ID 取得
# device_id = win32api.GetVolumeInformation("C:\\")[-1]
# print(device_id)
# print(sp.devices())
# device_id = "9f3029f50fe2ae7faca1056e4cf02cce291dd397"

param = {'device_id':device_id,
         'context_uri':'spotify:playlist:%s' % playlist_id}
# param = {'device_id':device_id,
#          'context_uri':'spotify:playlist:0Ud98MOBx8vgwmESw9rCqZ'}
# param = {'context_uri':'spotify:playlist:%s' % playlist_id}
...
# sp.next_track(param)
# sp.start_playback(f"https://api.spotify.com/v1/me/player/play?device_id={device_id}", {"uris":["spotify:track:0ipvRATjnKeAlIRNS5WqhN","spotify:track:4TzkNDcjO1wiaRYs2HLXvA"]})

# device_id_url = 'https://api.spotify.com/v1/me/player/devices'
# # print(requests.get("https://api.spotify.com/v1/me/player/play", headers = header))
# print(sp.devices()) # device_id))
...
# # list_data = sp.playlist_tracks(playlist_id) # "https://open.spotify.com/playlist/5CzbTLKqtxlXnUOkgd26qx?si=faf185194d9d4e01") # playlist id から中身の詳細情報検索可能
# list_data = sp.playlist_tracks(playlist_urls_list[1]) # 全てのプレイリストから選択
...
for i in range(playlist_num):
    ...
    # try:
    #     ave_bpm_for_select = bpm_sum_for_select/select_track_count # BPMの制約のみで平均を出す場合
    # except:
    #     print("count: ", select_track_count)
    # print("BPM AVERAGE FOR SELECT : ", ave_bpm)
    # ave_bpm_list_for_select.append(ave_bpm_for_select)

print("BPM AVERAGE LIST : ", ave_bpm_list) # プレイリスト全体の平均を出す場合
# print("BPM AVERAGE LIST FOR SELECT: ", ave_bpm_list_for_select) # BPMの制約のみで平均を出す場合
